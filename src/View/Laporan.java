...
public class Laporan {
    ...
    public void laporan(Buku buku){
        ...
        System.out.println("================");
        System.out.println("Daftar Tabel Buku");
        System.out.println("================");
        System.out.println("No Nama Buku\t\tStok \t\tHarga");
        for (int i = 0; i < total; i++) {
            System.out.println((i+1) + ". " + FormatString.formatStr(buku.getNamaBuku(i), 14) + "\t " + buku.getStok(i) + "\t\t\t" + buku.getHarga(i));
        }        
    }
    ...
    public void laporan(Siswa siswa){
        ...
        for (int i = 0; i < total; i++) {
            System.out.println((i + 1) + ". " + siswa.getNama(i) + "\t\t" + FormatString.formatStr(siswa.getAlamat(i), 10) + "\t" + siswa.getTelepon(i) + "\t" + siswa.getStatus(i));
        }
    }
    ...
    public void laporan(Peminjaman peminjaman, Buku buku){
        ...
        for (int i = 0; i < total; i++) {
            ...
            System.out.println((i+1) + ". " + FormatString.formatStr(buku.getNamaBuku(i), 12) + "\t " + peminjaman.getBanyak(i) + "\t    " + buku.getHarga(peminjaman.getIdBuku(i)) + "\t" + price);
        }
    }
}
